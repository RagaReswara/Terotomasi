...
WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Id User_id_user (1)'), Id_User)

WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Nama Petani_nama_petani'), Nama_Petani)

WebUI.setText(findTestObject('Object Repository/Page_/input_Tanggal Lahir_tanggal_lahir'), '11051997')

WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Nama Istri  Suami_nama_istri'), Nama_Suami_Istri)

WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Alamat Petani_alamat_petani'), Alamat_Petani)
...
WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Nomor Telepon_nomor_telpon'), Nomor_Telpon)

WebUI.selectOptionByValue(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/select_SD                                  _d31312'), 
    'S2', true)

WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Jumlah Lahan_jml_lahan'), Jumlah_Lahan)
...
WebUI.setText(findTestObject('Object Repository/Pengujian Insert Petani Berhasil/input_Email_email'), Email)
